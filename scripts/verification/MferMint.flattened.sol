...
// ===== File: project/contracts/MferMint.sol =====
...
contract MferMint is ERC721, Ownable {
    ...
    uint256 public constant MINT_PRICE = 300000000000000; 
    
    uint256 public constant PAYEE1_AMOUNT = 170000000000000; 
    uint256 public constant PAYEE2_AMOUNT = 130000000000000; 
    ...
    function mint() external payable {
        ...
        payee1.transfer(PAYEE1_AMOUNT);
        payee2.transfer(PAYEE2_AMOUNT);
    }
    ...
    function mintFor(address to, string calldata paymentId) external onlyRelayerOrGallery {
    ...
    function mintForWithEth(address to, string calldata paymentId) external payable onlyRelayerOrGallery {
        require(!processedPayment[paymentId], "Payment already processed");
        require(msg.value == MINT_PRICE, "Price mismatch");
        require(payee1 != address(0) && payee2 != address(0), "Payees not set");
    ...
    function mintForWithEthFromGallery(address to, string calldata paymentId) external payable onlyRelayerOrGallery {
        require(!processedPayment[paymentId], "Payment already processed");
...
// ===== File: project/contracts/Gallery.sol =====
// 
...
contract Gallery is Ownable {
    ...
    function processPayment(address artistContract, address to, uint256 amount, string calldata paymentId) external onlyRelayer {
        require(!processedPayment[paymentId], "Payment already processed");
        ...
        usdc.transfer(artistContract, net);
    ...
    function payAndMint(address artistContract, address to, string calldata paymentId) external payable {
        require(msg.value == MINT_PRICE, "Price mismatch");
